...
from .config_network import NetworkClientConfig


class NetworkClient(Robot):
    config_class = NetworkClientConfig
    name = "network_client"

    def __init__(self, config: NetworkClientConfig):
    ...
    def _state_ft(self) -> dict[str, type]:
        return dict.fromkeys(
            (
                ...
                "arm1_wrist_roll.pos",
                "arm1_gripper.pos",
                "arm2_shoulder_pan.pos",
                "arm2_shoulder_lift.pos",
                "arm2_elbow_flex.pos",
                "arm2_wrist_flex.pos",
                "arm2_wrist_roll.pos",
                "arm2_gripper.pos",
